...
abstract class UninstallatorAbstract implements UninstallatorInterface
{
    /**
    ...
    protected function getDirectoryContentsSimple($directory)
    {
        $source = $this->getDirectoryContents($directory);
        $result = [];
